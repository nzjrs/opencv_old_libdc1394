...
%CVDILATE            Apply maximum filter to the image
%   IMAGE dst = cvDilate(IMAGE src, elementValues, elementSize, iterations);
%   src           - source image
...
%
%   IMAGE dst = cvDilate(IMAGE src, elementType, elementSize, iterations);
%   src         - source image
...
[varargout{1:out}] = feval('cvwrap', 'Dilate', varargin{:});
