...
# ADD CPP /nologo /MD /W3 /GX /Zi /O2 /I "..\..\cxcore\include" /I "..\..\Cv\Include" /I "..\..\OtherLibs\HighGUI" /I "CVEiCL\EiC\src" /I "..\..\Filters\ProxyTrans" /I "CVEiCL\wrappers" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_AFXDLL" /D "_MBCS" /D "_CVL_SPECIFIC" /D "NO_LONG_LONG" /D "_IPPI_UNSAFE_PTR" /Fr /Yu"stdafx.h" /FD /c
...
# ADD LINK32 HighGUI.lib CVEiCL.lib strmbasd.lib strmiids.lib quartz.lib cv.lib /nologo /subsystem:windows /debug /machine:I386 /nodefaultlib:"libc" /out:"..\..\Bin\Hawk\Release/Hawk.exe" /libpath:"..\..\lib" /libpath:"..\..\OtherLibs\HighGUI\Release" /libpath:"..\..\OtherLibs\_ipl\lib\msvc" /libpath:"CVEiCL\lib"
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /Zi /Od /I "..\..\cxcore\include" /I "..\..\Cv\Include" /I "..\..\OtherLibs\HighGUI" /I "CVEiCL\EiC\src" /I "..\..\Filters\ProxyTrans" /I "CVEiCL\wrappers" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_CVL_SPECIFIC" /D "_AFXDLL" /D "NO_LONG_LONG" /D "_IPPI_UNSAFE_PTR" /FR /Yu"stdafx.h" /FD /GZ /c
...
# ADD LINK32 CVEiCLd.lib strmbasd.lib strmiids.lib quartz.lib cvd.lib highguid.lib /nologo /subsystem:windows /incremental:no /debug /machine:I386 /nodefaultlib:"libc" /out:"..\..\Bin\Hawk\Debug/Hawkd.exe" /pdbtype:sept /libpath:"..\..\lib" /libpath:"..\..\OtherLibs\HighGUI\Debug" /libpath:"..\..\OtherLibs\_ipl\lib\msvc" /libpath:"CVEiCL\lib"
# SUBTRACT LINK32 /verbose /pdb:none
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Desc=Copying wrapper headers
PostBuild_Cmds=if not exist ..\..\bin\Hawk\Debug\wrappers md ..\..\bin\Hawk\Debug\wrappers	del /S /Q ..\..\bin\Hawk\Debug\wrappers\*.*	copy ..\..\CV\include\*.* ..\..\bin\Hawk\debug\wrappers	copy convert.h ..\..\bin\Hawk\debug\wrappers\*.*	copy ..\..\OtherLibs\HighGUI\HighGUI.h ..\..\bin\Hawk\debug\wrappers\*.*	if not exist ..\..\bin\Hawk\debug\wrappers\std md ..\..\bin\Hawk\debug\wrappers\std	xcopy /s CVEiCL\EiC\src\win32\*.h ..\..\bin\Hawk\debug\wrappers\std\*.*	del ..\..\bin\Hawk\debug\wrappers\std\signal.h	copy wrappers.in ..\..\bin\Hawk\Debug\wrappers	copy ..\..\cvaux\include\*.h ..\..\bin\Hawk\debug\wrappers\*.*
# End Special Build Tool
